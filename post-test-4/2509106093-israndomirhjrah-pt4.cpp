...
void enqueue(Queue *q, Pasien p) {
    ...
    cout << "Posisi antrian: " << q->jumlah << " pasien\n";
}
...
void peekQueue(Queue *q) {
    ...
    cout << "\n=== PASIEN TERDEPAN ===\n";
    NodePasien* ptr = q->front;
    cout << "ID: " << ptr->data.idHewan << endl;
    cout << "Nama: " << ptr->data.namaHewan << endl;
    cout << "Jenis: " << ptr->data.jenisHewan << endl;
    cout << "Keluhan: " << ptr->data.keluhan << endl;
    cout << "Waktu Daftar: " << ptr->data.waktuDaftar << endl;
}
...
void tampilkanSemuaAntrian(Queue *q) {
    ...
    NodePasien* current = q->front;
    int no = 1;
    while (current != nullptr) {
        cout << setw(5) << no++
             << setw(5) << current->data.idHewan
             << setw(25) << current->data.namaHewan
             << setw(15) << current->data.jenisHewan
             << setw(30) << current->data.keluhan << endl;
...
void push(Stack *s, TindakanMedis t) {
    NodeTindakan* newNode = new NodeTindakan;
    newNode->data = t;
    newNode->next = s->top;
    s->top = newNode;
    s->jumlah++;
    ...
    cout << "Total riwayat: " << s->jumlah << " tindakan\n";
}
...
TindakanMedis pop(Stack *s) {
    ...
    NodeTindakan* temp = s->top;
    TindakanMedis t = temp->data;
    s->top = s->top->next;
    delete temp;
    s->jumlah--;
...
void peekStack(Stack *s) {
    ...
    cout << "\n=== TINDAKAN TERAKHIR ===\n";
    NodeTindakan* ptr = s->top;
    cout << "ID Pasien: " << ptr->data.idPasien << endl;
    cout << "Nama Hewan: " << ptr->data.namaHewan << endl;
    cout << "Tindakan: " << ptr->data.tindakan << endl;
    cout << "Obat: " << ptr->data.obat << endl;
    cout << "Waktu: " << ptr->data.waktuTindakan << endl;
}
...
void tampilkanSemuaRiwayat(Stack *s) {
    ...
    NodeTindakan* current = s->top;
    TindakanMedis tempArray[100];
    int count = 0;
    while (current != nullptr) {
        tempArray[count++] = current->data;
        current = current->next;
    }
    
    for (int i = count - 1; i >= 0; i--) {
        cout << setw(5) << (count - i)
             << setw(5) << tempArray[i].idPasien
             << setw(25) << tempArray[i].namaHewan
             << setw(25) << tempArray[i].tindakan
             << setw(25) << tempArray[i].obat << endl;
    }
    cout << endl;
}
